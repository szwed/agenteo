...
CNOE has developed and contributed several open-source Backstage plugins that integrate the [Developer Portal](Developer-Portal.md) with cloud-native technologies and workflows.

## Available Plugins

| Plugin | Repository | Description |
|--------|-----------|-------------|
| **Terraform Plugin** | [cnoe-io/plugin-terraform](https://github.com/cnoe-io/plugin-terraform) | Displays Terraform outputs and resources from TFState files associated with Backstage components. Connects the developer portal to [Infrastructure as Code](../4-kubernetes/Infrastructure-as-Code.md) visibility. |
| **Argo Workflows Plugin** | [cnoe-io/plugin-argo-workflows](https://github.com/cnoe-io/plugin-argo-workflows) | Displays Argo Workflows execution status and details within Backstage. Integrates [CI CD](../4-kubernetes/CI-CD.md) workflow visibility into the portal. |
...
- **Verification integration** -- The Scaffolder Backend can invoke [CNOE CLI](CNOE-CLI.md) verification checks as a step in template workflows, halting execution if prerequisites are not met

## See Also

- [Developer Portal](Developer-Portal.md) -- Backstage developer portal overview
